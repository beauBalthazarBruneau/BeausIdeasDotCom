...
export class MysteryBox {
  ...
  draw(ctx) {
    ...
    ctx.translate(this.x + this.width/2, this.y + this.height/2 - this.hitBounce);
  ...
  checkPlayerCollision(player) {
    ...
    if (collision) {
      ...
      console.log(`Collision detected! Moving up: ${playerMovingUp}, From below: ${hitFromBelow}, Velocity: ${player.body.velocity.y}`);
