...
export const ProjectData = Object.values(portfolioData.worlds).flatMap(
  (world) =>
...
export class ProjectManager {
  ...
  static getProjectsByCategory(category) {
    console.warn(
      'getProjectsByCategory: category field not available in simplified project data'
    );
    return [];
  }
  ...
  static getProjectsByStatus(status) {
    console.warn(
      'getProjectsByStatus: status field not available in simplified project data'
    );
    return [];
  }
