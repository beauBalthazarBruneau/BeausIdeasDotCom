...
export class HealthcareWorld {
  constructor(physics, worldTransitionManager) {
    ...
    console.log(`HealthcareWorld created with ${this.projects.length} projects`);
  }
  ...
  createDecorations() {
    this.decorativeElements.push(
      ...
      { type: 'medical-pillar', x: this.width - 100, y: this.groundLevel - 150 },
