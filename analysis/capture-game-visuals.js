    ...
    const analysis = await page.evaluate(() => {
      ...
      try {
        ...
        const samples = {
          ...
          center: {
            r: data[Math.floor(canvas.width / 2) * 4 + Math.floor(canvas.height / 2) * canvas.width * 4],
            g: data[Math.floor(canvas.width / 2) * 4 + Math.floor(canvas.height / 2) * canvas.width * 4 + 1],
            b: data[Math.floor(canvas.width / 2) * 4 + Math.floor(canvas.height / 2) * canvas.width * 4 + 2],
            a: data[Math.floor(canvas.width / 2) * 4 + Math.floor(canvas.height / 2) * canvas.width * 4 + 3]
          }
        };
